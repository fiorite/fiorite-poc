...
export function intersect<E>(other: Iterable<E>, comparer: EqualityComparer<E> = equals): Operator<E> {
...
export function intersectAsync<E>(other: AnyIterable<E>, comparer: EqualityComparer<E> = equals): AsyncOperator<E> {
